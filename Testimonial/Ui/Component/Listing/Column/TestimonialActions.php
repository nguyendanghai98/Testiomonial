        ...
        if(isset($dataSource['data']['items'])) {
            foreach($dataSource['data']['items'] as &$item)
            {
                $item[$this->getData('name')]['edit'] = [
                    'href' => $this->urlBuilder->getUrl('testimonial/index/edit', ['id' => $item['AHT_Testimonial_test_id']]),
                    'label' => __('Edit'),
                    'hidden' => false
                ];
                $item[$this->getData('name')]['delete'] = [
                    'href' => $this->urlBuilder->getUrl('testimonial/index/delete', ['id' => $item['AHT_Testimonial_test_id']]),
                    'label' => __('Delete'),
                    'hidden' => false
                ];
            }
